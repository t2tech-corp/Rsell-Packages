...
Item_Source_Modal_New <- function() {
    ...
    showModal(modalDialog(
        ...
        tags$div(
            ...
            actionButton("nisubmit", "Add Source", style = "color: white; background-color: #565455; border-color: #565455;", width = '25%'),
            tags$div(style = "display:inline-block; width: 35px", HTML("<br>")),
            actionButton("nicancel", "Cancel",     style = "color: white; background-color: #d91e2f; border-color: #d91e2f;", width = '25%')
